...
public static from_str(str: S, radix: u32, prefix: usize) -> Result<IPAddress, String> {
...
static enhance_if_mapped(ip: IPAddress) -> Result<IPAddress, String> {
...
public static ipv6_is_loopback(my: &IPAddress) -> bool {
    return my.host_address == BigUint::one();
}


public static ipv6_is_private(my: &IPAddress) -> bool {
