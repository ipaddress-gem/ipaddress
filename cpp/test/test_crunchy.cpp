...
int main(int, char **) {
  ...
  describe("#add", []() {
    ...
    it("Should add two identical numbers", []() {
      ...
      Chai::assert.deepEqual(x.add(y).to_8bit(), { 1, 255, 255, 255, 255, 255, 254 });
    ...
    it("Should add positive to negative number expecting positive result",
       []() {
         ...
         auto x = Crunchy::from_8bit({ 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
                                       0xff, 0xff, 0xff, 0xff,  0xff-20, 0xff-89, 0xff-145, 0xff-31 });
  ...
  describe("#sub", []() {
    ...
    it("Should subtract one", []() {
      ...
      Chai::assert.deepEqual(x.sub(y).to_8bit(), { 239, 255, 255, 255, 255, 255 });
  ...
  describe("#mul", []() {
    ...
    it("Should multiply numbers", []() {
      ...
      Chai::assert.deepEqual(x.mul(y).to_8bit(), { 255, 255, 255, 254, 0, 0, 0, 1 });
    });
  ...
  //     Crunchy.parse(s).to_8bit().should.eql([5, 57, 84, 76, 233, 0, 120, 91,
  //     180, 180, 8]);
