...
module IPAddress;
  ...
  class IPv6
    ...
    //
    pub fn to_string_uncompressed(&self) {
    ...
    pub fn to_string(&self) {
      return format!("{}/{}", self.compressed, self.prefix)
    }
    ...
    //      // => true
    //
    pub fn is_network(&self) {
      self.to_u128() | self.prefix.to_u128 == self.prefix.to_u128
    }
...
// puts "%s %x=>%x/%d"%[to_string, step,step_four_bit_net,next_four_bit_mask]
    ...
    //      // => "2001:db8::8:800:200c:417a/64"
    //
    pub fn self.parse_u128(u128, prefix=128)
    ...
    //      // => "2001:db8::8:800:200c:417a/64"
    //
    pub fn self.parse_hex(hex, prefix=128)
      self.parse_u128(hex.hex, prefix)
    end

    private

    pub fn compress_address
